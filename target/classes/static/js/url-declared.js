...
const url_api_product = 'https://fastfooddbapi.azurewebsites.net/api/v1/mat-hang'
const url_api_categories = 'https://fastfooddbapi.azurewebsites.net/api/v1/loai-mat-hang'
const url_api_client = 'https://fastfooddbapi.azurewebsites.net/api/v1/khach-hang'
const url_api_order = 'https://fastfooddbapi.azurewebsites.net/api/v1/don-dat-hang'
const url_api_introduce = 'https://fastfooddbapi.azurewebsites.net/api/v1/gioi-thieu'
const url_api_orderdetail = 'https://fastfooddbapi.azurewebsites.net/api/v1/chi-tiet-don-dat-hang'
const url_api_staff = 'https://fastfooddbapi.azurewebsites.net/api/v1/nhan-vien'
